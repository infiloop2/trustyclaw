...
class AdminApiIntegrationTests(unittest.TestCase):
    ...
    def test_admin_ui_has_thread_task_event_smoke_path(self) -> None:
        ...
        self.assertIn('data-action="new-thread"', ui)
        self.assertIn('$("new-task-thread").value = selectedThreadId', ui)
        self.assertIn('$("new-task-runtime").value = selectedThreadRuntime', ui)
